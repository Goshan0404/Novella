...
define config.name = _("Новая жизнь")
...
define gui.about = _p("""
Визуальная новелла, разработанная командой crackStatus в рамках
курса Основы проектной деятельности УрФУ ИРИТ-РТФ

Разработчик - Шептихин Вячеслав\n
Тимлид - Чернихов Георгий\n
Дизайнер - Сабирьянова Виктория\n
Сценарист - Гилев Андрей\n
Аналитик - Фоломкина Татьяна\n
""")
...
define config.save_directory = "crackStatus-1699786853"
